// CameraModal.js placehoexport default function CameraModal({ onSelect, onClose }) {
  return (
    <div style={{
      ...
      <div style={{
        background:'#fff', padding:24, borderRadius:12, width:280,
        boxShadow:'0 4px 12px rgba(0,0,0,.2)', textAlign:'center'
      }}>
